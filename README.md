...
- 🌐 **رابط کاربری فارسی**: داشبورد وب زیبا و کاربرپسند با Tailwind CSS
- 💾 **تاریخچه قیمت‌ها**: ذخیره تمام تغییرات قیمت در SQLite
- ⚡ **سریع و کارآمد**: استفاده از Playwright برای دریافت قیمت واقعی
- 🎨 **طراحی مدرن**: UI زیبا با انیمیشن و Responsive
- 🔒 **امن**: تمام داده‌ها به صورت محلی ذخیره می‌شوند

## 📸 تصاویر

```
[در اینجا می‌توانید اسکرین‌شات از داشبورد قرار دهید]
```
